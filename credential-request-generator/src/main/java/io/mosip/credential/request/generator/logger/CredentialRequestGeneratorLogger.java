package io.mosip.credential.request.generator.logger;

import io.mosip.kernel.core.logger.spi.Logger;
import io.mosip.kernel.logger.logback.appender.RollingFileAppender;
import io.mosip.kernel.logger.logback.factory.Logfactory;

public class CredentialRequestGeneratorLogger {
	...
	static {
		...
		mosipRollingFileAppender.setFileName("logs/credentialrequestgenerator.log");
		mosipRollingFileAppender.setFileNamePattern("logs/credentialrequestgenerator-%d{yyyy-MM-dd}-%i.log");
	 ...
	 */
	private CredentialRequestGeneratorLogger() {
	}
