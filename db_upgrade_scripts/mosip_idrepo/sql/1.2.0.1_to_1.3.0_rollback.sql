...
DROP INDEX IF EXISTS cred_status_uin_hash ON idrepo.handle;
DROP INDEX IF EXISTS cred_req_NEW_status_cr_dtimes ON idrepo.credential_request_status;
DROP INDEX IF EXISTS cred_tran_status ON idrepo.credential_request_status;