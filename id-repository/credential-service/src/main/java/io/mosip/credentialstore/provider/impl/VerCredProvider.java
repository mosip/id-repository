...
public class VerCredProvider extends CredentialProvider {
	...
	public DataProviderResponse getFormattedCredentialData(
		...
		try {
			...
			LocalDateTime localdatetime = LocalDateTime.parse(DateUtils.getUTCCurrentDateTimeString(environment.getProperty(DATETIME_PATTERN)), format);
			...
			String vcEncodedData = CryptoUtil.encodeBase64(vcSignBytes);
