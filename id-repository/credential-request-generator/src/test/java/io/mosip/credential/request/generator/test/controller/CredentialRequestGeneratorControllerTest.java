...
public class CredentialRequestGeneratorControllerTest {
	...
	public void testCreateRequestGenerationSuccess() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/requestgenerator").contentType(MediaType.APPLICATION_JSON_VALUE)
	...
	public void testGetRequestIdsSuccess() throws Exception {
		...
		Mockito.when(credentialRequestService.getRequestIds(Mockito.anyString(), Mockito.anyString(), Mockito.anyInt(),
				Mockito.anyInt(), Mockito.anyString(), Mockito.anyString())).thenReturn(responseWrapper);

		mockMvc.perform(MockMvcRequestBuilders.get("/getRequestIds").contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(status().isOk());
	...
	public void testHandleReSubscribeEventSuccess() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/scheduleRetrySubscription")).andExpect(status().isOk());
	...
	public void testScheduleWebsubSubscriptionSuccess() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/scheduleWebsubSubscription")).andExpect(status().isOk());
