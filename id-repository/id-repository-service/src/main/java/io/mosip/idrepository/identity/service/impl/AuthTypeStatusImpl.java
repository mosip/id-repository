...
public class AuthTypeStatusImpl implements AuthtypeStatusService {
	...
	/** Mosip logger. */
	private static final Logger mosipLogger = IdRepoLogger.getLogger(AuthTypeStatusImpl.class);

	/** The Constant HYPHEN. */
	private static final String HYPHEN = "-";

	/** Auth lock repository. */
	@Autowired
	...
	@Override
	/**
	 * Fetch auth type status.
	 * @param individualId individual id
	 * @param idType id type
	 * @return list<authtype status>
	 */
	public List<AuthtypeStatus> fetchAuthTypeStatus(String individualId, IdType idType) throws IdRepoAppException {
		...
		try {
			...
			IdentityServicePerformanceLog.log(mosipLogger, this.getClass().getSimpleName(), "fetchAuthTypeStatus",
					startNanos);
		}
	}
	...
	public IdResponseDTO updateAuthTypeStatus(String individualId, IdType idType, List<AuthtypeStatus> authTypeStatusList)
		...
		try {
			...
			IdentityServicePerformanceLog.log(mosipLogger, this.getClass().getSimpleName(), "updateAuthTypeStatus",
					startNanos);
		}
	}
