...
public class VidController {
	...
	private static final Logger mosipLogger = IdRepoLogger.getLogger(VidController.class);
	 ...
	 * @param errors errors
	 * @return response entity<response wrapper<vid response dto>>
	 */
	public ResponseEntity<ResponseWrapper<VidResponseDTO>> createVid(
			@Validated @RequestBody RequestWrapper<VidRequestDTO> request, @Parameter(hidden = true) Errors errors)
	 ...
	 * @param uin uin
	 * @return response entity<response wrapper<list<vid info dto>>>
	 */
