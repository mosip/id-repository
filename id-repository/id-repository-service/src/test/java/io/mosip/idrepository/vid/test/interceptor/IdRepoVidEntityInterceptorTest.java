...
public class IdRepoVidEntityInterceptorTest {
	...
	public void testOnSave() throws IdRepoAppException, JsonParseException, JsonMappingException, IOException {
		...
		assertFalse(interceptor.onSave(vid, null, new Object[] { "461_7329815461_7C9JlRD32RnFTzAmeTfIzg" },
				new String[] { "uin" }, null));
	}

	@Test
	public void testOnSaveEncryptionFailed() throws IdRepoAppException {
		when(securityManager.encryptWithSalt(Mockito.any(), Mockito.any(), Mockito.any()))
				.thenThrow(new IdRepoAppException());
		Vid vid = new Vid();
		vid.setUin("461_7329815461_7C9JlRD32RnFTzAmeTfIzg");
		try {
			interceptor.onSave(vid, null, new Object[] { "461_7329815461_7C9JlRD32RnFTzAmeTfIzg" },
					new String[] { "uin" }, null);
	...
	public void testOnFlushDirty() throws IdRepoAppException {
		...
		Vid vid = new Vid();
		vid.setUin("461_7329815461_7C9JlRD32RnFTzAmeTfIzg");
		assertFalse(interceptor.onFlushDirty(vid, null, new Object[] { "461_7329815461_7C9JlRD32RnFTzAmeTfIzg" }, null,
				new String[] { "uin" }, null));
	}
	...
	public void testOnFlushDirtyEncryptionFailed() throws IdRepoAppException {
		...
		vid.setUin("461_7329815461_7C9JlRD32RnFTzAmeTfIzg");
		try {
			interceptor.onFlushDirty(vid, null, new Object[] { "461_7329815461_7C9JlRD32RnFTzAmeTfIzg" }, null,
					new String[] { "uin" }, null);
		} catch (IdRepoAppUncheckedException e) {
			assertEquals(IdRepoErrorConstants.ENCRYPTION_DECRYPTION_FAILED.getErrorCode(), e.getErrorCode());
			assertEquals(IdRepoErrorConstants.ENCRYPTION_DECRYPTION_FAILED.getErrorMessage(), e.getErrorText());
