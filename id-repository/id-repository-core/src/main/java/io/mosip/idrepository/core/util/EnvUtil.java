...
import static io.mosip.idrepository.core.constant.IdRepoConstants.IDENTITY_UPDATE_COUNT_POLICY_FILE_URL;
...
public class EnvUtil {
	...
	public void init() {
		...
		setIdentityUpdateCountPolicyFileUrl(this.getProperty(IDENTITY_UPDATE_COUNT_POLICY_FILE_URL));
	}
