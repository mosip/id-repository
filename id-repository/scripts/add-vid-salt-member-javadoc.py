#!/usr/bin/env python3
"""Add field/method JavaDoc for vid and salt packages."""
import re
...
SKIP_METHODS = {"equals", "hashCode", "toString", "getClass", "notify", "notifyAll", "wait", "compareTo"}
    ...
    while i < len(lines):
        ...
        if at_class_body and not has_javadoc_before(out, len(out)):
            ...
            if fm and fm.group(5) not in ("serialVersionUID",):
                ...
                if fname == "LOGGER" or fname == "mosipLogger" or not fname.isupper():
