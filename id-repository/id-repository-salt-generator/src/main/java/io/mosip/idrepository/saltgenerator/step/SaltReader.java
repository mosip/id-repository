...
public class SaltReader implements ItemReader<IdRepoSaltEntitiesComposite> {
	...
	public IdRepoSaltEntitiesComposite read() {
		if (startSeq <= endSeq) {
			String idHshSalt = CryptoUtil.encodeBase64(HMACUtils2.generateSalt());
			...
			String idEncSalt = CryptoUtil.encodeBase64(HMACUtils2.generateSalt());
			...
			String vidEncSalt = CryptoUtil.encodeBase64(HMACUtils2.generateSalt());
