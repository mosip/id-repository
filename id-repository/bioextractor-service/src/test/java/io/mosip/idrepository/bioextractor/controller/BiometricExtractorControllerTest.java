package io.mosip.idrepository.bioextractor.controller;
...
public class BiometricExtractorControllerTest {
	...
	public void before() {
		...
		ReflectionTestUtils.setField(biometricExtractorController, "biometricExtractionService",
				biometricExtractionService);
